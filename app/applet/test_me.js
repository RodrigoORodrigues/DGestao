...
const rows = "some\n12331588 1128951 23 04/2026 1.416,08 Médico 1 05/05/2026 20/05/2026 ".split(
    /(?=\b\d{5,12}\s+\S+\s+(?:\d{1,4}\s+)?(?:(?:\d{2}\/\d{4})|(?:\d{2}\/\d{2}\/\d{4})))/
);

console.log({matchBase, mDate, mValue, rows});
